...
/**
 * Floating bottom-left stats: big visited count, world percentage and
 * per-continent mini progress bars. Recomputes from the optimistic
 * visits cache, so it updates instantly on toggle.
 */
export function StatsBar() {
  ...
  return (
    <section
      ...
      className="absolute bottom-4 left-4 z-20 w-56 rounded-2xl border border-white/10 bg-white/5 p-4 shadow-2xl backdrop-blur-xl"
    >
